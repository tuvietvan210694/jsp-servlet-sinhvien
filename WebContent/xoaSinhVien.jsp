...
<div class="container">
    ...
    <form action="XoaSinhVienServlet" method="post">
        ...
        <div class="row form-group">
            ...
            <div class="col-lg-3">
                <input type="radio" name="gioitinh" value="1" style="margin-right: 10px;" readonly="readonly" disabled="disabled">Nam
                <input type="radio" style="margin: 0px 10px 0px 30px;" name="gioitinh" value="0" readonly="readonly" disabled="disabled">Nữ
            </div>
        </div>
        <div class="row form-group">
